...
## 🚀 Features  
- Collects **7+ years of race and qualifying data** via the [FastF1 API](https://theoehrly.github.io/Fast-F1/).  
...
## Future Improvements
-  Dynamic Retraining – Continuously retrain as new race results are added.
-  Richer Features – Incorporate tyre strategy, pit stop data, and weather conditions.
-  API Deployment – Wrap the model into a FastAPI REST API for live predictions.
-  Interactive Dashboard – Build a lightweight web dashboard for visualization

---

## Skills Demonstrated
- **Data Engineering** : Data collection, cleaning and merging with Pandas
- **Feature Engineering** : Domain-informed metrics (driver and team form, circuit history)
- **Machine Learning** : Used XGBoost regression, evaluation, and model persistence using joblib
